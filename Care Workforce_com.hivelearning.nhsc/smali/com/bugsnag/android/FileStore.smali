...
.field protected final delegate:Lcom/bugsnag/android/FileStore$Delegate;

.field final lock:Ljava/util/concurrent/locks/Lock;

.field private final maxStoreCount:I

.field final queuedFiles:Ljava/util/Collection;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field final storeDirectory:Ljava/lang/String;


# direct methods
.method constructor <init>(Lcom/bugsnag/android/Configuration;Landroid/content/Context;Ljava/lang/String;ILjava/util/Comparator;Lcom/bugsnag/android/FileStore$Delegate;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 52
    iput-object p1, p0, Lcom/bugsnag/android/FileStore;->config:Lcom/bugsnag/android/Configuration;

    .line 53
    iput p4, p0, Lcom/bugsnag/android/FileStore;->maxStoreCount:I

    .line 54
    iput-object p5, p0, Lcom/bugsnag/android/FileStore;->comparator:Ljava/util/Comparator;
    ...
    .line 68
    invoke-static {v0, p2}, Lcom/bugsnag/android/Logger;->warn(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method enqueueContentForDelivery(Ljava/lang/String;)V
    .locals 9
    ...
    .line 89
    iget-object v6, p0, Lcom/bugsnag/android/FileStore;->delegate:Lcom/bugsnag/android/FileStore$Delegate;
    ...
    invoke-interface {v6, p1, v5, v7}, Lcom/bugsnag/android/FileStore$Delegate;->onErrorIOFailure(Ljava/lang/Exception;Ljava/io/File;Ljava/lang/String;)V

    .line 93
    :cond_1
    invoke-static {v5}, Lcom/bugsnag/android/IOUtils;->deleteFile(Ljava/io/File;)V
    :try_end_3
...
.method write(Lcom/bugsnag/android/JsonStream$Streamable;)Ljava/lang/String;
    ...
    .line 122
    :try_start_1
    invoke-virtual {v2, p1}, Lcom/bugsnag/android/JsonStream;->value(Lcom/bugsnag/android/JsonStream$Streamable;)V
    ...
    .line 134
    :cond_1
    invoke-static {v3}, Lcom/bugsnag/android/IOUtils;->deleteFile(Ljava/io/File;)V
